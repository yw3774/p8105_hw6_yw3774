...
```
Base on the result above, we can draw a conclusion that model 1 has the lowest RMSE, which means it is the best fitted one. The model 2 has the highest RMSE.
...
```
The values of log(beta0_hat * beta1_hat) by using bootstraping are approximately normally distributed with a mean around 2.02, and the 95% confidence interval is [1.966, 2.059].
